...
public interface Plans {
    default <OP_TYPE extends LogicalOperator> LogicalLeafPlan<OP_TYPE> plan(OP_TYPE op) {
        return new LogicalLeafPlan(op);
    }

    default <OP_TYPE extends LogicalOperator, CHILD_TYPE extends Plan> LogicalUnaryPlan<OP_TYPE, CHILD_TYPE>
            plan(OP_TYPE op, CHILD_TYPE child) {
        return new LogicalUnaryPlan(op, child);
    }

    default <OP_TYPE extends LogicalOperator, LEFT_CHILD_TYPE extends Plan, RIGHT_CHILD_TYPE extends Plan>
    ...
    default <OP_TYPE extends PhysicalOperator> PhysicalLeafPlan<OP_TYPE>
            plan(OP_TYPE op, LogicalProperties logicalProperties) {
        return new PhysicalLeafPlan(op, logicalProperties);
    }

    default <OP_TYPE extends PhysicalOperator, CHILD_TYPE extends Plan> PhysicalUnaryPlan<OP_TYPE, CHILD_TYPE>
    ...
    default <OP_TYPE extends PhysicalOperator, LEFT_CHILD_TYPE extends Plan, RIGHT_CHILD_TYPE extends Plan>
