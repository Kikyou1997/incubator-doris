...
public class Pattern<TYPE extends NODE_TYPE, NODE_TYPE extends TreeNode<NODE_TYPE>>
    ...
    public static final Pattern ANY = new Pattern(org.apache.doris.nereids.operators.OperatorType.ANY);
    public static final Pattern MULTI = new Pattern(org.apache.doris.nereids.operators.OperatorType.MULTI);
    public static final Pattern FIXED = new Pattern(org.apache.doris.nereids.operators.OperatorType.FIXED);
    public static final Pattern MULTI_FIXED = new Pattern(org.apache.doris.nereids.operators.OperatorType.MULTI_FIXED);

    protected final List<Predicate<TYPE>> predicates;
    protected final org.apache.doris.nereids.operators.OperatorType operatorType;
     ...
     */
    public Pattern(org.apache.doris.nereids.operators.OperatorType operatorType, Pattern... children) {
     ...
     * @param children sub pattern
     */
    public Pattern(org.apache.doris.nereids.operators.OperatorType operatorType, List<Predicate<TYPE>> predicates, Pattern... children) {
        super(OperatorType.PATTERN, children);
        this.operatorType = operatorType;
     ...
     */
    public org.apache.doris.nereids.operators.OperatorType getOperatorType() {
        return operatorType;
    }

    public boolean isFixed() {
        return operatorType == org.apache.doris.nereids.operators.OperatorType.FIXED;
    }

    public boolean isAny() {
        return operatorType == org.apache.doris.nereids.operators.OperatorType.ANY;
    }

    public boolean isMulti() {
        return operatorType == org.apache.doris.nereids.operators.OperatorType.MULTI;
    }
    ...
    public boolean matchOperator(Operator operator) {
        ...
        if (operatorType == org.apache.doris.nereids.operators.OperatorType.MULTI || operatorType == org.apache.doris.nereids.operators.OperatorType.ANY
                || operatorType == org.apache.doris.nereids.operators.OperatorType.MULTI_FIXED || operatorType == org.apache.doris.nereids.operators.OperatorType.FIXED) {
            return true;
        }
